...
export const controlDefinitions: ControlDefinition[] = [
  ...
  { type: 'icon-star', name: '별', category: 'icon', description: '즐겨찾기, 평점 등에 쓰는 별 아이콘', defaultWidth: 56, defaultHeight: 56 },
  { type: 'icon-home', name: '홈', category: 'icon', description: '홈 화면으로 이동하는 아이콘', defaultWidth: 56, defaultHeight: 56 },
  { type: 'icon-search', name: '검색', category: 'icon', description: '검색을 나타내는 돋보기 아이콘', defaultWidth: 56, defaultHeight: 56 },
  { type: 'icon-settings', name: '설정', category: 'icon', description: '설정 화면으로 이동하는 톱니바퀴 아이콘', defaultWidth: 56, defaultHeight: 56 },
  { type: 'icon-check', name: '체크', category: 'icon', description: '완료, 확인을 나타내는 체크 아이콘', defaultWidth: 56, defaultHeight: 56 },
  { type: 'icon-close', name: '닫기', category: 'icon', description: '닫기, 취소를 나타내는 X 아이콘', defaultWidth: 56, defaultHeight: 56 },
  { type: 'icon-plus', name: '추가', category: 'icon', description: '새 항목 추가를 나타내는 아이콘', defaultWidth: 56, defaultHeight: 56 },
  { type: 'icon-user', name: '사용자', category: 'icon', description: '프로필, 계정을 나타내는 아이콘', defaultWidth: 56, defaultHeight: 56 },
  { type: 'icon-info', name: '정보', category: 'icon', description: '안내 문구를 나타내는 아이콘', defaultWidth: 56, defaultHeight: 56 },
  { type: 'icon-heart', name: '하트', category: 'icon', description: '좋아요, 즐겨찾기를 나타내는 아이콘', defaultWidth: 56, defaultHeight: 56 },
]
